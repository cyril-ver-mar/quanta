...
""",
        ...
        "results_profile_lorentzian": "Lorentzian",
        "results_profile_voigt": "Voigt",
        "results_profile_pseudovoigt": "Pseudo-Voigt",
        "results_fwhm": "FWHM (eV)",
        "results_fraction": "GL fraction",
        "results_fraction_help": "0 = Gaussian, 1 = Lorentzian (Pseudo-Voigt / Voigt mix).",
        "results_show_refs": "Show reference BEs",
        "results_refs_caption": "References:",
        "results_dl_spec_csv": "CSV · {element}1s",
        "results_dl_spec_img": "{fmt} · {element}1s",
        "results_dl_excel": "Excel (all curves)",
        "results_dl_tiff": "TIFF (first curve)",
        "results_export_all": "Batch export",
        "results_export_hint": "PNG/JPEG per element above; Excel packs all curves + peak table.",
        "compounds_test_mols": "Test molecules",
        ...
        "log_viewer_title": "Gaussian log viewer",
        "log_viewer_select": "Log file",
        "log_viewer_empty": "No .log / .out files yet for this job.",
        "log_viewer_errors_found": "Diagnostics found in the log (see below).",
        "log_viewer_incomplete": "Log did not end with Normal termination.",
        "log_viewer_show_full": "Show full log (unchecked = last 120 lines)",
        "log_viewer_tail_hint": "Showing last {n} lines — enable full log if needed.",
        "log_viewer_body": "Log text",
        "log_viewer_download": "Download log",
...
""",
        ...
        "settings_dscf_g09_hint": "G09 uses PBEPBE (not bare pbe) and Integral=UltraFine.",
...
""",
    ...
    "ru": {
        ...
        "nav_group_main": "Рабочая область",
        "nav_group_workflow": "Расчёт",
...
""",
        ...
        "results_profile_lorentzian": "Лоренц",
        "results_profile_voigt": "Voigt",
        "results_profile_pseudovoigt": "Псевдо-Voigt",
        "results_fwhm": "FWHM (эВ)",
        "results_fraction": "Доля GL",
        "results_fraction_help": "0 = Гаусс, 1 = Лоренц (для псевдо-Voigt / Voigt).",
        "results_show_refs": "Показать справочные BE",
        "results_refs_caption": "Справка:",
        "results_dl_spec_csv": "CSV · {element}1s",
        "results_dl_spec_img": "{fmt} · {element}1s",
        "results_dl_excel": "Excel (все кривые)",
        "results_dl_tiff": "TIFF (первая кривая)",
        "results_export_all": "Пакетный экспорт",
        "results_export_hint": "PNG/JPEG по элементам выше; Excel — все кривые и таблица пиков.",
        "compounds_test_mols": "Тестовые молекулы",
        ...
        "log_viewer_title": "Просмотр Gaussian log",
        "log_viewer_select": "Файл log",
        "log_viewer_empty": "Пока нет .log / .out для этого задания.",
        "log_viewer_errors_found": "В log найдены сообщения об ошибке (ниже).",
        "log_viewer_incomplete": "Log не закончился Normal termination.",
        "log_viewer_show_full": "Показать весь log (без галочки — последние 120 строк)",
        "log_viewer_tail_hint": "Показаны последние {n} строк — включите полный log при необходимости.",
        "log_viewer_body": "Текст log",
        "log_viewer_download": "Скачать log",
...
""",
        ...
        "settings_dscf_g09_hint": "В G09: PBEPBE (не просто pbe) и Integral=UltraFine.",
